...
export default function DeveloperAbout() {
    return (
    <section id="about" className="w-full h-auto md:h-screen py-20 md:py-0 flex flex-col items-start justify-center px-5 md:px-28 border-b-2">
            <div className="w-full flex flex-col-reverse md:flex-row gap-10 ">
                <div className=" md:w-[65%] md:gap-10 flex flex-col">
                    <div className="flex items-center gap-3 text-xl mb-2.5 md:mb-0">
                        <div className="w-3 h-3 bg-[var(--black)] rounded-full"></div> About Me
                    </div>
                    <p className="text-2xl md:text-[32px] text-justify leading-9 md:leading-14 mb-10 md:mb-0">I have 3 years of experience as an AI/ML engineer, software developer, and workflow automation. My work includes deep learning and computer vision projects, as well as building scalable software and automated workflows. I enjoy creating practical, AI-driven solutions that improve efficiency and deliver real value.</p>
                ...
                <div className="md:w-[35%] flex flex-col justify-end">
                    <div className="w-full h-96 md:h-full relative overflow-hidden">
